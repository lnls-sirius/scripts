...
cd /home/sirius/shared && tar cfv - screens-iocs | ssh ximenes.resende@swc-server-ibm1 "cat > /mnt/nfs/ibira/lnls/labs/fac/backups/data_by_day/screens-iocs_$timestamp.tar"
