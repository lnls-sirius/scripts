...
function status {
  ...
  get_password
  bbb="bbb-tb-quadrupoles" && ioc_cmd $bbb status; printf "\n\n"
  bbb="bbb-tb-correctors" && ioc_cmd $bbb status; printf "\n\n"
  bbb="bbb-tb-dipoles" && ioc_cmd $bbb status; printf "\n\n"
  bbb="bbb-as-dclinks" && ioc_cmd $bbb status; printf "\n\n"
}
